...
from research_supervisor.prompts import lead_researcher_prompt
from research.agent import researcher_agent
from research_supervisor.states import (
    SupervisorState,
    ConductResearch,
    ResearchComplete
)
from research.functions import get_today_str
from research.tools import think_tool
    ...
    if exceeded_iterations or no_tool_calls or research_complete:
        ...
        try:
            ...
            if conduct_research_calls:
                ...
                # Give each sub-agent a unique thread_id so they don't overwrite each other's memories!
                coros = [
                    researcher_agent.ainvoke({
                        ...
                        "run_name": f"Parallel_Worker_{tool_call['id'][-4:]}"
                    })
...
memory = MemorySaver()
supervisor_agent = supervisor_builder.compile(checkpointer=memory, name="Supervisor_Agent")